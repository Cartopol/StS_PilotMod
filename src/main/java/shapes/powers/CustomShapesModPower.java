...
public abstract class CustomShapesModPower extends AbstractPower implements CloneablePowerInterface, CustomStackBehaviorPower {
    ...
    public CustomShapesModPower(StaticPowerInfo staticPowerInfo) {
        super();
    ...
    public void stackPower(AbstractPower otherPower) {
        ...
        if (this.amount2 != -1 || this.canGoNegative2 && otherPower instanceof CustomShapesModPower) {
            this.fontScale = 8.0F;
            this.amount2 += ((CustomShapesModPower) otherPower).amount2;
        }
    }
