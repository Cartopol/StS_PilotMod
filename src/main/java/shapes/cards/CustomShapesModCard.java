...
public abstract class CustomShapesModCard extends CustomCard {
    ...
    private static String imgFromId(String id) {
        ...
        return ShapesMod.makeCardPath(String.format("generated/%1$s.png", unprefixedId));
    }

    public CustomShapesModCard(final String id,
                               final int cost,
                               final CardType type,
    ...
    private CustomShapesModCard(final String id,
