...
import shapes.relics.CustomShapesModRelic;
import shapes.util.ReflectionUtils;
import shapes.util.TextureLoader;
import shapes.variables.BaseBlockNumber;
import shapes.variables.BaseDamageNumber;
import shapes.variables.MetaMagicNumber;
import shapes.variables.UrMagicNumber;
...
@SpireInitializer
public class ShapesMod implements
        EditCardsSubscriber,
        ...
        StartActSubscriber,
        StartGameSubscriber {
    public static final String MOD_ID = "shapes";

    public static final Logger logger = LogManager.getLogger(ShapesMod.class.getName());

    public static final String MODNAME = "The Shapes";
    private static final String AUTHOR = "";
    private static final String DESCRIPTION = "The Shapes";

    // =============== INPUT TEXTURE LOCATION =================

    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "shapesResources/images/Badge.png";
    ...
    public ShapesMod() {
        ...
        ShapesModSettings.initialize();
        logger.info("Done adding mod settings");

        logger.info("Creating new card colors...");
        Shapes.ColorInfo.registerColorWithBaseMod();
    ...
    public static void initialize() {
        logger.info("========================= Initializing ShapesMod. =========================");
        ShapesMod defaultmod = new ShapesMod();
        logger.info("========================= /ShapesMod Initialized./ =========================");
    }
    ...
    public void receiveEditCharacters() {
        ...
        logger.info("Adding Shapes...");
        BaseMod.addCharacter(
                new Shapes("The Shapes", Shapes.Enums.SHAPES),
                Shapes.CHARACTER_SELECT_BUTTON_TEXTURE,
                Shapes.CHARACTER_SELECT_BG_TEXTURE,
                Shapes.Enums.SHAPES);
    ...
    public void registerPowersInDevConsole() {
        ...
        ArrayList<Class<AbstractPower>> powers = ReflectionUtils.findAllConcreteShapesModClasses(new RegexClassFilter("^shapes\\.powers\\.(.+)Power$"));
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.registerModBadge(badgeTexture, MODNAME, AUTHOR, DESCRIPTION, ShapesModSettings.createSettingsPanel());
    ...
    public void receiveEditRelics() {
        ...
        List<CustomShapesModRelic> relics = ReflectionUtils.instantiateAllConcreteShapesModSubclasses(CustomShapesModRelic.class);
        for (CustomShapesModRelic relicInstance : relics) {
...
//        new AutoAdd(ShapesMod.MOD_ID).packageFilter("cards").setDefaultSeen(true).cards();

        List<CustomShapesModCard> cards = ReflectionUtils.instantiateAllConcreteShapesModSubclasses(CustomShapesModCard.class);
        for (CustomShapesModCard cardInstance : cards) {
    ...
    public void receiveEditStrings() {
        ...
        loadStrings(CardStrings.class, "ShapesMod-Card-Strings.json");
        loadStrings(CharacterStrings.class, "ShapesMod-Character-Strings.json");
        loadStrings(EventStrings.class, "ShapesMod-Event-Strings.json");
        loadStrings(PotionStrings.class, "ShapesMod-Potion-Strings.json");
        loadStrings(PowerStrings.class, "ShapesMod-Power-Strings.json");
        loadStrings(RelicStrings.class, "ShapesMod-Relic-Strings.json");
        loadStrings(UIStrings.class, "ShapesMod-UI-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(makeLocalizedStringsPath(Settings.language, "ShapesMod-Keyword-Strings.json")).readString(String.valueOf(StandardCharsets.UTF_8));
